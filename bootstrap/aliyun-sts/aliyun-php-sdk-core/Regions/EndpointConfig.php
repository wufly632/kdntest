 ...
 * under the License.
 */
$regionIds = array("cn-hangzhou","cn-beijing","cn-qingdao","cn-hongkong","cn-shanghai","us-west-1","cn-shenzhen","ap-southeast-1","ap-south-1");
$productDomains =array(
	...
	new ProductDomain("Oss", env('OSS_ENDPOINT')),
...
$endpoint = new Endpoint(env('STS_REGIN_ID'), $regionIds, $productDomains);
