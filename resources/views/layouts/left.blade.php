    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="{{cdn_asset('assets/admin-lte//dist/img/user2-160x160.jpg')}}" class="img-circle"
                     alt="User Image">
            </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a data-target-url="mobilecategorys" href="{{secure_route('mobile.categorys.index')}}"><i
                                    class="fa fa-circle-o"></i>H5分类</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
