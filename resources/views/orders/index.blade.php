                                    ...
                                    <tr class="">
                                        <td colspan="6">
                                            ...
                                            <p class="col-sm-2">收货人: <span class="text-primary"
                                                                           style="cursor: pointer">{{ isset($orderlist->customer->firstname)? $orderlist->customer->firstname : '' . ' ' . isset($orderlist->customer->lastname) ? $orderlist->customer->lastname:'' }}</span>
                                            </p>
                                        </td>
                                    </tr>
